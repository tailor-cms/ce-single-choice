...
Server-side module for the **Single Choice** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-single-choice-server
```
...
```ts
import serverModule from '@tailor-cms/ce-single-choice-server';
```
