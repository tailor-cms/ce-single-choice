...
Shared element definition for the **Single Choice** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-single-choice-manifest
```
...
```ts
import manifest, { type ElementData } from '@tailor-cms/ce-single-choice-manifest';

manifest.type;       // 'SINGLE_CHOICE'
